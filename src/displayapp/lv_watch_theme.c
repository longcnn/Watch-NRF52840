...
static void basic_init(void) {
  ...
  lv_style_set_value_color(&style_box, LV_STATE_DEFAULT, LV_WATCH_BLUE);
  ...
  lv_style_set_border_color(&style_box_border, LV_STATE_DEFAULT, LV_WATCH_GRAY);
  lv_style_set_text_color(&style_box, LV_STATE_DEFAULT, LV_WATCH_BLUE);

  style_init_reset(&style_title);
  lv_style_set_text_color(&style_title, LV_STATE_DEFAULT, LV_WATCH_WHITE);
  lv_style_set_text_font(&style_title, LV_STATE_DEFAULT, theme.font_subtitle);

  style_init_reset(&style_label_white);
  lv_style_set_text_color(&style_label_white, LV_STATE_DEFAULT, LV_WATCH_WHITE);
  ...
  lv_style_set_pad_left(&style_btn, LV_STATE_DEFAULT, LV_DPX(0));
  lv_style_set_pad_right(&style_btn, LV_STATE_DEFAULT, LV_DPX(0));
  lv_style_set_pad_top(&style_btn, LV_STATE_DEFAULT, LV_DPX(0));
  lv_style_set_pad_bottom(&style_btn, LV_STATE_DEFAULT, LV_DPX(0));
  lv_style_set_pad_inner(&style_btn, LV_STATE_DEFAULT, LV_DPX(0));
  lv_style_set_outline_width(&style_btn, LV_STATE_DEFAULT, LV_DPX(0));
  ...
  lv_style_set_border_color(&style_btn_border, LV_STATE_DEFAULT, LV_WATCH_WHITE);
  lv_style_set_border_width(&style_btn_border, LV_STATE_DEFAULT, 0);
  lv_style_set_bg_opa(&style_btn_border, LV_STATE_DEFAULT, LV_OPA_TRANSP);
  lv_style_set_bg_color(&style_btn_border, LV_STATE_DEFAULT, LV_WATCH_WHITE);
  lv_style_set_text_color(&style_btn_border, LV_STATE_DEFAULT, LV_WATCH_WHITE);
  lv_style_set_value_color(&style_btn_border, LV_STATE_DEFAULT, LV_WATCH_WHITE);
  lv_style_set_transition_prop_3(&style_btn_border, LV_STATE_DEFAULT, LV_STYLE_BG_OPA);

  style_init_reset(&style_icon);
  lv_style_set_text_color(&style_icon, LV_STATE_DEFAULT, LV_WATCH_WHITE);

  style_init_reset(&style_back);
  lv_style_set_value_color(&style_back, LV_STATE_DEFAULT, LV_WATCH_GRAY);
...
/*
  ...
  lv_style_set_bg_color(&style_scrollbar, LV_STATE_DEFAULT, LV_WATCH_LIGHT_GRAY);
  ...
  lv_style_set_bg_color(&style_list_btn, LV_STATE_DEFAULT, LV_WATCH_WHITE);
  lv_style_set_bg_color(&style_list_btn, LV_STATE_CHECKED, LV_WATCH_GRAY);
  lv_style_set_bg_color(&style_list_btn, LV_STATE_CHECKED | LV_STATE_PRESSED, lv_color_darken(LV_WATCH_GRAY, LV_OPA_20));
  lv_style_set_text_color(&style_list_btn, LV_STATE_DEFAULT, LV_WATCH_BLUE);
  lv_style_set_text_color(&style_list_btn, LV_STATE_CHECKED, LV_WATCH_WHITE);
  lv_style_set_text_color(&style_list_btn, LV_STATE_CHECKED | LV_STATE_PRESSED, LV_WATCH_WHITE);
  lv_style_set_image_recolor(&style_list_btn, LV_STATE_DEFAULT, LV_WATCH_BLUE);
  lv_style_set_image_recolor(&style_list_btn, LV_STATE_CHECKED, LV_WATCH_WHITE);
  lv_style_set_image_recolor(&style_list_btn, LV_STATE_CHECKED | LV_STATE_PRESSED, LV_WATCH_WHITE);
  ...
  lv_style_set_shadow_color(&style_ddlist_list, LV_STATE_DEFAULT, LV_WATCH_GRAY);
  lv_style_set_bg_color(&style_ddlist_list, LV_STATE_DEFAULT, LV_WATCH_GRAY);

  style_init_reset(&style_ddlist_selected);
  lv_style_set_bg_opa(&style_ddlist_selected, LV_STATE_DEFAULT, LV_OPA_COVER);
  lv_style_set_bg_color(&style_ddlist_selected, LV_STATE_DEFAULT, LV_WATCH_BLUE);

  style_init_reset(&style_sw_bg);
  lv_style_set_bg_opa(&style_sw_bg, LV_STATE_DEFAULT, LV_OPA_COVER);
  lv_style_set_bg_color(&style_sw_bg, LV_STATE_DEFAULT, LV_WATCH_LIGHT_GRAY);
  lv_style_set_radius(&style_sw_bg, LV_STATE_DEFAULT, LV_RADIUS_CIRCLE);
  lv_style_set_value_color(&style_sw_bg, LV_STATE_DEFAULT, LV_WATCH_BLUE);

  style_init_reset(&style_sw_indic);
  lv_style_set_bg_opa(&style_sw_indic, LV_STATE_DEFAULT, LV_OPA_COVER);
  lv_style_set_bg_color(&style_sw_indic, LV_STATE_DEFAULT, LV_WATCH_GREEN);

  style_init_reset(&style_sw_knob);
  lv_style_set_bg_opa(&style_sw_knob, LV_STATE_DEFAULT, LV_OPA_COVER);
  lv_style_set_bg_color(&style_sw_knob, LV_STATE_DEFAULT, LV_WATCH_WHITE);
...
*/
  ...
  lv_style_set_line_color(&style_arc_indic, LV_STATE_DEFAULT, LV_WATCH_WHITE);
  lv_style_set_line_width(&style_arc_indic, LV_STATE_DEFAULT, LV_DPX(9));
  lv_style_set_line_rounded(&style_arc_indic, LV_STATE_DEFAULT, true);

  style_init_reset(&style_arc_bg);
  lv_style_set_line_color(&style_arc_bg, LV_STATE_DEFAULT, LV_CHARGING_GRAY);
  lv_style_set_line_width(&style_arc_bg, LV_STATE_DEFAULT, LV_DPX(9));
  ...
  lv_style_set_bg_color(&style_arc_knob, LV_STATE_DEFAULT, LV_WATCH_LIGHT_GRAY);
  lv_style_set_pad_all(&style_arc_knob, LV_STATE_DEFAULT, LV_DPX(0));

  /*style_init_reset(&style_table_cell);
  lv_style_set_border_color(&style_table_cell, LV_STATE_DEFAULT, LV_WATCH_GRAY);
...
/*
  ...
  lv_style_set_line_color(&style_chart_serie, LV_STATE_DEFAULT, LV_WATCH_WHITE);
...
static void theme_apply(lv_obj_t* obj, lv_theme_style_t name) {
  ...
  switch (name_int) {
    ...
    case LV_THEME_TABLE:
     ...
     //int idx = 1;
      /* start value should be 1, not zero, since cell styles
