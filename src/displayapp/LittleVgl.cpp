...
LittleVgl::LittleVgl(Watch::Drivers::St7789& lcd, Watch::Drivers::Cst816S& touchPanel)
...
void LittleVgl::InitTheme() {
  lv_theme_t* th = lv_watch_theme_init(
    LV_COLOR_WHITE, LV_COLOR_SILVER, 0, &San_Francisco_20, &San_Francisco_20, &San_Francisco_20, &San_Francisco_20);
